...
### E2. Nenhuma nota cadastrada
1. No passo 6, o sistema verifica que o aluno não possui notas registradas.
2. O sistema exibe a mensagem **Nenhuma nota disponível no momento**.
3. O caso de uso é encerrado.

## Regras de Negócio
- O aluno só pode consultar suas próprias notas.
- Apenas usuários autenticados podem acessar as notas.
